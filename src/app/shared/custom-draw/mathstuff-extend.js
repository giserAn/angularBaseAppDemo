const mathstuffextend = {};
mathstuffextend._gsQueue = [];
var bigfunc = function () {
    "use strict";
    mathstuffextend._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function (a, b, c) {
    ...
    }, !0), mathstuffextend._gsDefine("TimelineLite", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function (a, b, c) {
        var d = function (a) {
    ...
    }, !0), mathstuffextend._gsDefine("TimelineMax", ["TimelineLite", "TweenLite", "easing.Ease"], function (a, b, c) {
        var d = function (b) {
    ...
    }, !0), mathstuffextend._gsDefine("plugins.BezierPlugin", ["plugins.TweenPlugin"], function (a) {
        var b = function () {
        ...
        return c.constructor = b, b.API = 2, b._autoCSS = !0, b.quadraticToCubic = function (a, b, c) {
            ...
            var a = (mathstuffextend.GreenSockGlobals || mathstuffextend).com.greensock.plugins.CSSPlugin;
            if (a) {
    ...
    }, !0), mathstuffextend._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function (a) {
        ...
        var G, H, I, J, K, L, j = /(?:\d|\-\d|\.\d|\-\.\d)+/g, k = /(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g, l = /(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b)/gi, m = /[^\d\-\.]/g, n = /(?:\d|\-|\+|=|#|\.)*/g, o = /opacity *= *([^)]*)/, p = /opacity:([^;]*)/, q = /alpha\(opacity *=.+?\)/i, r = /([A-Z])/g, s = /-([a-z])/gi, t = /(^(?:url\(\"|url\())|(?:(\"\))$|\)$)/gi, u = function (a, b) {
            ...
            mathstuffextend.console && console.log(a)
        }, P = "", Q = "", R = function (a, b) {
            b = b || C;
            var d, e, c = b.style;
        ...
        var ob = function (a, b, c, d, e, f, g) {
            ...
            if (!h[a]) {
                ...
                pb(a, null, function (a, c, d, e, f, g, i) {
                    var j = (mathstuffextend.GreenSockGlobals || mathstuffextend).com.greensock.plugins[b];
    ...
    }, !0), mathstuffextend._gsDefine("plugins.RoundPropsPlugin", ["plugins.TweenPlugin"], function (a) {
        var b = function () {
    ...
    }, !0), mathstuffextend._gsDefine("easing.Back1", ["easing.Ease"], function (a) {
        var n, o, b = mathstuffextend.GreenSockGlobals || mathstuffextend, c = b.com.greensock, d = 2 * Math.PI, e = Math.PI / 2, f = c._class, g = function (b, c) {
...
mathstuffextend._gsQueue.push(bigfunc)
